...
class AdvertiseController extends Controller
{
  ...
  public function save(Request $request)
  {
    $validator = Validator::make($request->all(), [
      ...
      'title.required' => 'Tiêu đề Baner Quảng Cáo không được để trống!',
    ...
    return redirect()->route('admin.advertise.index')->with(['alert' => [
      'type' => 'success',
      'title' => 'Thành Công',
      'content' => 'Baner Quảng Cáo của bạn đã được tạo thành công.'
    ]]);
  }
  ...
  public function delete(Request $request)
  {
    ...
    if(!$advertise) {
      ...
      $data['type'] = 'error';
      $data['title'] = 'Thất Bại';
      $data['content'] = 'Bạn không thể xóa Baner Quảng Cáo không tồn tại!';
    } else {
      ...
      $data['content'] = 'Xóa Baner Quảng Cáo thành công!';
    }
  ...
  public function update(Request $request, $id)
  {
    ...
    return redirect()->route('admin.advertise.index')->with(['alert' => [
      'type' => 'success',
      'title' => 'Thành Công',
      'content' => 'Baner Quảng Cáo của bạn đã được cập nhật thành công.'
    ]]);
  }
}
