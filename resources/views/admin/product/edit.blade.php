      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="rear_camera">Sạc Nhanh <span class="text-red">*</span></label>
                <input type="text" name="rear_camera" class="form-control" id="rear_camera" placeholder="Sạc Nhanh" required autocomplete="off" value="{{ $product->rear_camera }}">
              </div>
            </div>
          </div>
          <div class="row">
        ...
        <div class="box box-solid box-default collapsed-box" style="margin-bottom: 5px;">
          <div class="box-header">
            ...
            <div class="box-tools">
              ...
              <a href="javascript:void(0);" data-id="{{ $promotion->id }}" class="btn btn-box-tool remove-promotion" title="Xóa" data-url="{{ route('admin.product.delete_promotion') }}" style="color: #16A34A;">
        ...
        @if($product->product_details->isNotEmpty())
          ...
          <div class="box box-solid box-default collapsed-box" style="margin-bottom: 5px;">
            <div class="box-header">
              ...
              <div class="box-tools">
                <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-plus"></i></button>
                <a href="javascript:void(0);" data-id="{{ $product_detail->id }}" class="btn btn-box-tool remove-product-detail" title="Xóa" data-url="{{ route('admin.product.delete_product_detail') }}" style="color: #16A34A;">
                  <i class="fa fa-times"></i>
                </a>
              </div>
            </div>
