          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="rear_camera" class="form-control" id="rear_camera" placeholder="Sạc Nhanh" required autocomplete="off">
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="CPU">Camera sau <span class="text-red">*</span></label>
                <input type="text" name="CPU" class="form-control" id="CPU" placeholder="Camera sau" required autocomplete="off">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
