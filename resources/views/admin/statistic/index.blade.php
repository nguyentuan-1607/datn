                ...
                <div class="row">
                  ...
                  <div class="col-sm-3 col-xs-3">
                    <div class="description-block border-right description-revenue">
                      <h5 class="description-header"><span style="color: #16A34A;">{{ number_format($data['total_revenue'],0,',','.').' VNĐ' }}</span></h5>
                  ...
                  <div class="col-sm-3 col-xs-3">
                    <div class="description-block description-profit">
                      <h5 class="description-header"><span style="color: #16A34A;">{{ number_format($data['total_profit'],0,',','.').' VNĐ' }}</span></h5>
                    ...
                    <tbody>
                      ...
                      @foreach($data['order_details'] as $key => $order_detail)
                        ...
                        <tr>
                          ...
                          <td style="vertical-align: middle;"><span style="color: #16A34A;">{{ number_format($order_detail->product_detail->import_price,0,',','.') }} VNĐ</span></td>
                          <td style="vertical-align: middle;"><span style="color: #16A34A;">{{ number_format($order_detail->price,0,',','.') }} VNĐ</span></td>
                          <td style="vertical-align: middle;"><span style="color: #16A34A;">{{ number_format($order_detail->price * $order_detail->quantity,0,',','.') }} VNĐ</span></td>
                          <td style="vertical-align: middle;"><span style="color: #16A34A;">{{ number_format($order_detail->quantity * ($order_detail->price - $order_detail->product_detail->import_price),0,',','.') }} VNĐ</span></td>
                        </tr>
                      @endforeach
                      <tr>
                        <td colspan="11" style="text-align: right;">
                          <i style="margin-right: 10px;">*Tổng Doanh Thu = <span style="color: #16A34A;">{{ number_format($price,0,',','.') }} VNĐ</span></i>
                          <i>*Tổng Lợi Nhuận = <span style="color: #16A34A;">{{ number_format($profit,0,',','.') }} VNĐ</span></i>
                        </td>
                      </tr>
                    </tbody>
                  </table>
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          $('.box-table table tbody').append(
            '<tr>' +
              '<td colspan="11" style="text-align: right;">' +
                '<i style="margin-right: 10px;">*Tổng Doanh Thu = <span style="color: #16A34A;">' + formatMoney(price) + '</span></i>' +
                '<i>*Tổng Lợi Nhuận = <span style="color: #16A34A;">' + formatMoney(profit) + '</span></i>' +
              '</td>' +
            '</tr>'
          );
        },
  ...
  $(document).ready(function() {
    $('.btn-print').click(function(){
      printJS({
        ...
        type: 'html',
        documentTitle: ' ',
        header: 'Báo Cáo Tình Hình Kinh Doanh Website WebBanDienThoai',
