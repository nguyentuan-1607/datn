...
@section('title', 'Quản Lý Baner Quảng Cáo')
...
<ol class="breadcrumb">
  ...
  <li class="active">Quản Lý Baner Quảng Cáo</li>
</ol>
@endsection
  ...
  $(function () {
    var table = $('#advertise-table').DataTable({
      "language": {
        ...
        "info":           "Hiển thị trang <b>_PAGE_/_PAGES_</b> của <b>_TOTAL_</b> hình ảnh Baner Quảng Cáo",
        "infoEmpty":      "Hiển thị trang <b>1/1</b> của <b>0</b> hình ảnh Baner Quảng Cáo",
        "infoFiltered":   "(Tìm kiếm từ <b>_MAX_</b> hình ảnh Baner Quảng Cáo)",
        "emptyTable": "Không có dữ liệu hình ảnh Baner Quảng Cáo",
      },
      "lengthChange": false,
       "autoWidth": false,
       "order": [],
  ...
  $(document).ready(function(){
    ...
    $(".deleteDialog").click(function() {
      ...
      Swal.fire({
        type: 'question',
        title: 'Thông báo',
        text: 'Bạn có chắc muốn xóa Baner Quảng Cáo này?',
