...
@section('title', 'Tạo Baner Quảng Cáo Mới')
...
<ol class="breadcrumb">
  ...
  <li class="active">Tạo Baner Quảng Cáo Mới</li>
</ol>
@endsection
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="form-group">
            ...
            <input type="text" name="title" class="form-control" id="title" placeholder="Tiêu đề Baner Quảng Cáo" value="{{ old('title') }}" autocomplete="off">
          </div>
          <div class="row">
            <div class="col-md-5">
              <div class="form-group">
