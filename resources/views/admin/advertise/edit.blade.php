...
@section('title', 'Chỉnh Sửa Baner Quảng Cáo')
...
<ol class="breadcrumb">
  ...
  <li><a href="{{ route('admin.advertise.index') }}"><i class="fa fa-sliders" aria-hidden="true"></i> Quản Lý Baner Quảng Cáo</a></li>
  <li class="active">Chỉnh Sửa Baner Quảng Cáo</li>
</ol>
@endsection
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="form-group">
            ...
            <input type="text" name="title" class="form-control" id="title" placeholder="Tiêu đề Baner Quảng Cáo" value="{{ old('title') ?: $advertise->title }}" autocomplete="off">
          </div>
          <div class="row">
            <div class="col-md-5">
              <div class="form-group">
