            ...
            @foreach($orders as $order)
              ...
              <li>
                ...
                <div class="timeline-item">
                  ...
                  <h3 class="timeline-header"><a>{{ $user->name }}</a> đã mua <b style="color: #16A34A;">{{ $qty }}</b> sản phẩm với giá trị <b style="color: #16A34A;">{{ number_format($price,0,',','.') }}</b> VNĐ</h3>
                        ...
                        <tbody>
                          @foreach($order->order_details as $key => $order_detail)
                            <tr>
                              ...
                              <td class="text-center" style="color: #16A34A; vertical-align: middle;">{{ number_format($order_detail->price,0,',','.') }}₫</td>
                            </tr>
                          @endforeach
                        </tbody>
                      </table>
