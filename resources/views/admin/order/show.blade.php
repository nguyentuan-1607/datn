          ...
          <h2 class="page-header">
            <div style="display: inline-flex; align-items: center;">
              <div style="width: 30px; margin-right: 5px;">
                <img src="{{ asset('images/aaaa32.png') }}" alt="WebBanDienThoai Logo" style="width: 100%; height: auto; object-fit: cover;">
              </div>
              <div style="color: #f33;">Cửa hàng máy tinh</div>
            </div>
      ...
      <div class="invoice-info">
        <div class="row">
          <div class="col-md-3 col-sm-3 col-xs-3">
            ...
            <br>
            <address>
              <b>Admin WebBanDienThoai</b><br>
              Phone: (+84) 967 999 999<br>
              Email: shopdienthoai@gmail.com<br>
            ...
            <tbody>
              ...
              @foreach($order->order_details as $key => $order_detail)
                ...
                <tr>
                  ...
                  <td><span style="color: #16A34A;">{{ number_format($order_detail->price,0,',','.') }} VNĐ</span></td>
                  <td><span style="color: #16A34A;">{{ number_format($order_detail->price * $order_detail->quantity,0,',','.') }} VNĐ</span></td>
                </tr>
              @endforeach
              <tr>
                  <td colspan="7" style="text-align: right;"><b>Tổng = <span style="color: #16A34A;">{{ number_format($price,0,',','.') }} VNĐ</span></b></td>
                </tr>
            </tbody>
          </table>
        </div>
          ...
          <div class="table-responsive">
            <table class="table">
              <tr>
                ...
                <td><span style="color: #16A34A;">{{ number_format($price,0,',','.') }} VNĐ</span></td>
              </tr>
              <tr>
                <th>Đã Thanh Toán:</th>
                @if(Str::contains($order->payment_method->name, 'Online Payment'))
                <td><span style="color: #16A34A;">{{ number_format($price,0,',','.') }} VNĐ</span></td>
                @else
                <td><span style="color: #16A34A;">0 VNĐ</span></td>
                @endif
              </tr>
              <tr>
