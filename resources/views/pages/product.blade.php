                  ...
                  <div class="price-product">
                    @foreach($data['product_details'] as $key => $product)
                      ...
                      @endif
                        ...
                        @else
                          <div class="status">Tình trạng: <span style="color: #16A34A;">Hết hàng</span></div>
                        @endif
                      </div>
                    @endforeach
                  </div>
              ...
              <div class="infomation-detail">
                ...
                <div class="infomation-content">
                  <ul>
                    ...
                    <li><label>Sạc Nhanh:</label>{{ $data['product']->rear_camera ?: 'Đang Cập Nhật...' }}</li>
                    ...
                    <li><label>Camera sau:</label>{{ $data['product']->CPU ?: 'Đang Cập Nhật...' }}</li>
