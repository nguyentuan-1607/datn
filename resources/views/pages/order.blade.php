                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="order-info-center">
                    ...
                    <div class="order-info-content">
                      ...
                      <div><span>Đơn giá</span> <span style="color: #16A34A;">{{ number_format($price,0,',','.') }}₫</span></div>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <tbody>
                    @foreach($data['order']->order_details as $key => $order_detail)
                      <tr>
                        ...
                        <td class="text-center" style="color: #16A34A;">{{ number_format($order_detail->price,0,',','.') }}₫</td>
                      </tr>
                    @endforeach
                  </tbody>
                </table>
