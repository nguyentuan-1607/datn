...
Route::namespace('Admin')
    ...
    ->group(function () {
        ...
        Route::patch('orders/{order}/status', 'OrderController@updateStatus')->name('order.updateStatus');
...
/*
|--------------------------------------------------------------------------
| Chat AI Route (dùng cho nút chat GPT)
|--------------------------------------------------------------------------
*/
Route::post('/chat-ai', [ChatAIController::class, 'chat'])->name('chat_ai');
